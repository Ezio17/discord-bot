let allCountryCity = `
Австралия/Канберра/Австрия/Вена/Азербайджан/Баку/Албания/Тирана/Алжир/Алжир/Ангола/Луанда/Андорра/Андорра-ла-Велья/Антигуа и Барбуда/Сент-Джонс/Аргентина/Буэнос-Айрес/Армения/Ереван/Афганистан/Кабул/Багамы/Нассау/Бангладеш/Дакка/Барбадос/Бриджтаун/Бахрейн/Манама/Беларусь/Минск/Белиз/Бельмопан/Бельгия/Брюссель/
Бенин/Порто-Ново/
Болгария/София/
Боливия/Сукре/
...
let cityCountryArray = allCountryCity
  .toLowerCase()
  .replace(/\r?\n/g, '')
  .trim()
  .split('/');

export default cityCountryArray;
